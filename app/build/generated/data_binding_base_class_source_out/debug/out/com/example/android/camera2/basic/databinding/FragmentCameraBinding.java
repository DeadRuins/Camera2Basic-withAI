...
public final class FragmentCameraBinding implements ViewBinding {
  ...
  private FragmentCameraBinding(@NonNull FrameLayout rootView, @NonNull ImageButton captureButton,
      @Nullable ImageButton folderButton, @NonNull View overlay,
  ...
  public static FragmentCameraBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentCameraBinding((FrameLayout) rootView, captureButton, folderButton, overlay,
          viewFinder);
    }
